...
plot_dataset(relpath+"sigma0.003125-np1-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.003125, 0.02766, "sor", 1, 0, 0)
plot_dataset(relpath+"sigma0.003125-np2-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.003125, 0.02766, "sor", 2, 0, 1)

plot_dataset(relpath+"sigma0.03125-np1-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.03125, 0.07854, "sor", 1, 1, 0)
plot_dataset(relpath+"sigma0.03125-np2-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.03125, 0.07854, "sor", 2, 1, 1)

plot_dataset(relpath+"sigma0.3125-np1-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.3125, 0.1395, "sor", 1, 2, 0)
plot_dataset(relpath+"sigma0.3125-np2-SOR/elChargeN-diffusive-flux-1D-*-t00000000.h5", 0.3125, 0.1395, "sor", 2, 2, 1)
